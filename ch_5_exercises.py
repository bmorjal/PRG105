...
def joke():
    print('What did the cat say to the human before crossing the road. Meow.')
...
# Display the result
number_to_round = 4.24


def main7():
    r = math.ceil(number_to_round)
    print(r)
    floor()
    sqrt()
...
def floor():
    r = math.floor(number_to_round)
    print(r)


def sqrt():
    r = math.sqrt(number_to_round)
    print(r)
