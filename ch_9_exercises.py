...
birthdays = {'Meri': 'May 16', 'Kathy': 'July 14', 'Blake': 'Sept 18', 'Rachel': 'Dec 30', 'Jacob': 'Jun 24'}
...
for key, value1 in miles_ridden.items():
    print(key, ':', value1)
